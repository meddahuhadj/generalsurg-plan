          ...
          // IA hors-ligne). Quelques modales secondaires (respCycle, raymarching-dvr, Surg*)
          ...
          const MODULES = {
            laryngologie: {
              id: 'laryngologie', name: 'Chirurgie Laryngée & VADS', short: 'Laryngologie', icon: '🗣️',
              color: '#dc2626', colorRgb: '220,38,38',
              desc: 'Planification de chirurgie carcinologique du larynx et des voies aéro-digestives supérieures, avec stadification TNM et évaluation de la mobilité cordale.',
              procedures: ['Laryngectomie totale', 'Laryngectomie partielle (cordectomie)', 'Chirurgie transorale au laser CO2', 'Curage cervical fonctionnel', 'Trachéotomie'],
              metrics: [
                { key: 'T', label: 'Stade T (UICC)', val: 'T3', st: 'warn' },
                { key: 'Mobilité', label: 'Mobilité cordale', val: 'Fixée', st: 'warn' },
                { key: 'N', label: 'Adénopathies (N)', val: 'N1', st: 'warn' },
                { key: 'Marge', label: 'Marge de résection prévue', val: '> 5 mm', st: 'ok' }
              ],
              structures: [
                { name: 'Larynx', open: true, children: ['Épiglotte', 'Bande ventriculaire', 'Corde vocale droite', 'Corde vocale gauche', 'Commissure antérieure', 'Sous-glotte'] },
                { name: 'Cartilages', open: true, children: ['Cartilage thyroïde', 'Cartilage cricoïde', 'Aryténoïdes'] },
                { name: 'Espaces paraglottiques', open: false, children: ['Espace paraglottique dr.', 'Espace paraglottique g.', 'Espace pré-épiglottique'] },
                { name: 'Ganglions cervicaux', open: false, children: ['Niveau II', 'Niveau III', 'Niveau IV', 'Niveau VI (récurrentiel)'] }
              ],
              implants: [
                { name: 'Prothèse phonatoire (Provox)', ref: 'PVX-VEGA', tags: ['réhabilitation', 'voix'], sel: true },
                { name: 'Stent laryngé en silicone', ref: 'LAR-STENT-M', tags: ['calibrage'], sel: false },
                { name: 'Canule de trachéotomie fenêtrée', ref: 'TRA-FEN-8', tags: ['voies aériennes'], sel: false }
              ],
              checklist: [
                { done: true, text: '<strong>Nasofibroscopie / laryngoscopie</strong> — Extension muqueuse, mobilité cordale' },
                { done: true, text: '<strong>Scanner cervico-thoracique injecté</strong> — Extension cartilagineuse et ganglionnaire' },
                { done: true, text: '<strong>Biopsie + histologie</strong> — Confirmation diagnostique' },
                { done: false, text: '<strong>TEP-TDM</strong> — Bilan d\'extension à distance' },
                { done: false, text: '<strong>Consultation orthophoniste</strong> — Préparation à la réhabilitation vocale' }
              ],
              patient: { id: '40218-LAR', nom: 'Haddad, Omar', age: 63, sexe: 'M', poids: 74, taille: 173, diag: 'Carcinome épidermoïde du larynx cT3N1M0, corde vocale fixée', urg: 'rouge' },
              aiChips: ['Stade TNM exact ?', 'Laryngectomie totale ou partielle ?', 'Risque de récidive locale ?', 'Réhabilitation vocale post-op ?'],
              hubProcs: ['Laryngectomie totale', 'Cordectomie laser', 'Curage cervical', 'Trachéotomie']
            },
            otologie: {
              id: 'otologie', name: 'Chirurgie Otologique', short: 'Otologie', icon: '👂',
              color: '#0ea5e9', colorRgb: '14,165,233',
              desc: 'Planification de chirurgie de l\'oreille moyenne et de la mastoïde, avec évaluation audiométrique et surveillance du nerf facial.',
              procedures: ['Tympanoplastie', 'Mastoïdectomie', 'Ossiculoplastie', 'Implantation cochléaire', 'Stapédotomie (otospongiose)'],
              metrics: [
                { key: 'PTA', label: 'Seuil auditif moyen (PTA)', val: '55 dB', st: 'warn' },
                { key: 'HB', label: 'Grade House-Brackmann (VII)', val: 'I', st: 'ok' },
                { key: 'Rinne', label: 'Test de Rinne', val: 'Négatif', st: 'warn' },
                { key: 'Cholestéatome', label: 'Stade cholestéatome (EAONO-JOS)', val: 'Stade II', st: 'warn' }
              ],
              structures: [
                { name: 'Oreille externe', open: true, children: ['Conduit auditif externe', 'Membrane tympanique'] },
                { name: 'Oreille moyenne', open: true, children: ['Marteau', 'Enclume', 'Étrier', 'Caisse du tympan', 'Fenêtre ovale', 'Fenêtre ronde'] },
                { name: 'Mastoïde', open: false, children: ['Antre mastoïdien', 'Cellules mastoïdiennes', 'Sinus sigmoïde'] },
                { name: 'Oreille interne / Nerf facial', open: false, children: ['Cochlée', 'Vestibule', 'Canaux semi-circulaires', 'Nerf facial (VII) — segment tympanique', 'Nerf facial (VII) — segment mastoïdien'] }
              ],
              implants: [
                { name: 'Prothèse ossiculaire partielle (PORP)', ref: 'PORP-TI-4.5', tags: ['ossiculoplastie'], sel: true },
                { name: 'Prothèse ossiculaire totale (TORP)', ref: 'TORP-TI-6', tags: ['ossiculoplastie'], sel: false },
                { name: 'Implant cochléaire multicanal', ref: 'CI-MC-22', tags: ['implant', 'audition'], sel: false },
                { name: 'Piston en téflon (stapédotomie)', ref: 'STA-PIS-0.4', tags: ['otospongiose'], sel: false }
              ],
              checklist: [
                { done: true, text: '<strong>Audiométrie tonale et vocale</strong> — Seuils préopératoires' },
                { done: true, text: '<strong>Impédancemétrie</strong> — Fonction tubaire et réflexe stapédien' },
                { done: true, text: '<strong>Scanner des rochers</strong> — Anatomie osseuse, extension cholestéatome' },
                { done: false, text: '<strong>IRM (séquence diffusion)</strong> — Si suspicion cholestéatome résiduel' },
                { done: false, text: '<strong>Bilan vestibulaire</strong> — Si vertiges associés' }
              ],
              patient: { id: '52130-OTO', nom: 'Lefèvre, Claire', age: 38, sexe: 'F', poids: 61, taille: 166, diag: 'Cholestéatome de l\'oreille moyenne droite, stade II EAONO-JOS', urg: 'orange' },
              aiChips: ['Risque de paralysie faciale post-op ?', 'Gain auditif attendu ?', 'Indication d\'implant cochléaire ?', 'Risque de récidive de cholestéatome ?'],
              hubProcs: ['Tympanoplastie', 'Mastoïdectomie', 'Implant cochléaire', 'Stapédotomie']
            },
            rhinologie: {
              id: 'rhinologie', name: 'Chirurgie Rhino-Sinusienne', short: 'Rhinologie', icon: '👃',
              color: '#22c55e', colorRgb: '34,197,94',
              desc: 'Planification de chirurgie endoscopique naso-sinusienne avec cartographie tomodensitométrique (Lund-Mackay) et repérage des structures à risque.',
              procedures: ['Chirurgie endoscopique des sinus (CEES)', 'Septoplastie', 'Turbinectomie', 'Exérèse de tumeur naso-sinusienne', 'Réparation de brèche ostéo-méningée'],
              metrics: [
                { key: 'Lund-Mackay', label: 'Score de Lund-Mackay', val: '14/24', st: 'warn' },
                { key: 'SNOT-22', label: 'Score SNOT-22', val: '48/110', st: 'warn' },
                { key: 'NP', label: 'Score endoscopique polypes', val: '5/8', st: 'warn' },
                { key: 'Olfaction', label: 'Test olfactif (Sniffin\' Sticks)', val: 'Hyposmie modérée', st: 'warn' }
              ],
              structures: [
                { name: 'Cavités nasales', open: true, children: ['Cloison nasale', 'Cornet inférieur', 'Cornet moyen', 'Cornet supérieur'] },
                { name: 'Sinus antérieurs', open: true, children: ['Sinus maxillaire dr.', 'Sinus maxillaire g.', 'Sinus frontal', 'Cellules ethmoïdales antérieures'] },
                { name: 'Sinus postérieurs', open: false, children: ['Cellules ethmoïdales postérieures', 'Sinus sphénoïdal'] },
                { name: 'Structures à risque', open: true, children: ['Lame criblée', 'Artère ethmoïdale antérieure', 'Nerf optique', 'Artère carotide interne'] }
              ],
              implants: [
                { name: 'Mèche résorbable nasale', ref: 'MER-RES-8', tags: ['hémostase'], sel: true },
                { name: 'Attelle de cloison en silicone', ref: 'ATT-SIL-S', tags: ['septoplastie'], sel: false },
                { name: 'Ballonnet de sinusplastie', ref: 'BAL-SIN-6', tags: ['dilatation'], sel: false }
              ],
              checklist: [
                { done: true, text: '<strong>Scanner des sinus</strong> (coupes coronales) — Score de Lund-Mackay' },
                { done: true, text: '<strong>Endoscopie naso-sinusienne</strong> — Cartographie des polypes' },
                { done: true, text: '<strong>Score SNOT-22 préop.</strong> — Retentissement fonctionnel' },
                { done: false, text: '<strong>Bilan allergologique</strong> — Recherche de terrain atopique' },
                { done: false, text: '<strong>Arrêt anticoagulants / antiagrégants</strong> — Selon protocole' }
              ],
              patient: { id: '61045-RHI', nom: 'Fontaine, Renaud', age: 47, sexe: 'M', poids: 84, taille: 179, diag: 'Polypose naso-sinusienne bilatérale récidivante, Lund-Mackay 14/24', urg: 'vert' },
              aiChips: ['Risque de brèche méningée ?', 'Extension orbitaire ou endocrânienne ?', 'Risque de récidive de polypose ?', 'Indication chirurgicale ou traitement médical ?'],
              hubProcs: ['CEES', 'Septoplastie', 'Turbinectomie', 'Exérèse tumorale']
            },
            cervicofacial: {
              id: 'cervicofacial', name: 'Chirurgie Cervico-Faciale', short: 'Cervico-Facial', icon: '🦋',
              color: '#a855f7', colorRgb: '168,85,247',
              desc: 'Planification de chirurgie des glandes salivaires, de la thyroïde/parathyroïde et des curages ganglionnaires cervicaux, avec préservation du nerf facial et du nerf récurrent.',
              procedures: ['Parotidectomie', 'Curage ganglionnaire cervical (I-V)', 'Thyroïdectomie', 'Exérèse de kyste/fistule cervicale congénitale', 'Sous-maxillectomie'],
              metrics: [
                { key: 'HB', label: 'Grade House-Brackmann prévisionnel', val: 'I', st: 'ok' },
                { key: 'Vol', label: 'Volume glande parotide', val: '32 ml', st: 'ok' },
                { key: 'N', label: 'Niveaux ganglionnaires envahis', val: 'II-III', st: 'warn' },
                { key: 'PTH', label: 'PTH préop. (si thyroïde)', val: '58 pg/ml', st: 'ok' }
              ],
              structures: [
                { name: 'Glande parotide', open: true, children: ['Lobe superficiel', 'Lobe profond', 'Nerf facial (tronc et branches)'] },
                { name: 'Glande sous-maxillaire', open: false, children: ['Loge sous-maxillaire', 'Canal de Wharton'] },
                { name: 'Cou', open: true, children: ['Triangle cervical antérieur', 'Triangle cervical postérieur', 'Muscle sterno-cléido-mastoïdien', 'Veine jugulaire interne'] },
                { name: 'Ganglions cervicaux', open: false, children: ['Niveau I', 'Niveau II', 'Niveau III', 'Niveau IV', 'Niveau V', 'Niveau VI'] }
              ],
              implants: [
                { name: 'Neuromonitoring du nerf facial', ref: 'NIM-FACE-2', tags: ['monitoring', 'nerf facial'], sel: true },
                { name: 'Drain aspiratif de Redon', ref: 'RED-12-CH', tags: ['drainage'], sel: false },
                { name: 'Substitut dermique (lambeau)', ref: 'DERM-SUB-M', tags: ['reconstruction'], sel: false }
              ],
              checklist: [
                { done: true, text: '<strong>Échographie cervicale + cytoponction</strong> — Caractérisation de la masse' },
                { done: true, text: '<strong>IRM cervico-faciale</strong> — Extension locale, rapport au nerf facial' },
                { done: false, text: '<strong>Panendoscopie des VADS</strong> — Si suspicion tumorale primitive' },
                { done: false, text: '<strong>Neuromonitoring du nerf facial disponible</strong> — Vérification matériel' },
                { done: false, text: '<strong>Consultation anesthésie</strong> — Score ASA' }
              ],
              patient: { id: '47762-CEF', nom: 'Boukhalfa, Nadia', age: 52, sexe: 'F', poids: 66, taille: 163, diag: 'Tumeur du lobe superficiel de la parotide droite, adénome pléomorphe suspecté', urg: 'vert' },
              aiChips: ['Risque de paralysie faciale ?', 'Extension ganglionnaire ?', 'Type de curage indiqué ?', 'Préservation du nerf spinal accessoire ?'],
              hubProcs: ['Parotidectomie', 'Curage cervical', 'Thyroïdectomie', 'Exérèse kyste cervical']
            },
            pediatrique: {
              id: 'pediatrique', name: 'ORL Pédiatrique', short: 'ORL Pédiatrique', icon: '🧒',
              color: '#ec4899', colorRgb: '236,72,153',
              desc: 'Planification de chirurgie ORL de l\'enfant : anneau de Waldeyer, aérateurs trans-tympaniques et extraction de corps étranger des voies aéro-digestives.',
              procedures: ['Amygdalectomie', 'Adénoïdectomie', 'Pose d\'aérateurs trans-tympaniques (ATT)', 'Extraction de corps étranger des voies aériennes/digestives', 'Laryngotrachéoplastie'],
              metrics: [
                { key: 'OSA-18', label: 'Score OSA-18', val: '68/126', st: 'warn' },
                { key: 'Amygdales', label: 'Grade amygdalien (Brodsky)', val: '3/4', st: 'warn' },
                { key: 'SpO2min', label: 'SpO2 nocturne minimale', val: '89%', st: 'warn' },
                { key: 'Poids', label: 'Poids/âge (percentile)', val: 'P25', st: 'ok' }
              ],
              structures: [
                { name: 'Anneau de Waldeyer', open: true, children: ['Amygdales palatines', 'Végétations adénoïdes', 'Amygdale linguale'] },
                { name: 'Voies aériennes pédiatriques', open: false, children: ['Larynx sous-glottique', 'Trachée', 'Bronches souches'] },
                { name: 'Oreille', open: false, children: ['Caisse du tympan', 'Trompe d\'Eustache'] },
                { name: 'Corps étranger', open: true, children: ['Site œsophagien', 'Site laryngo-trachéal', 'Site bronchique'] }
              ],
              implants: [
                { name: 'Aérateur trans-tympanique (yoyo)', ref: 'ATT-YOYO-1', tags: ['aération', 'oreille moyenne'], sel: true },
                { name: 'Sonde d\'intubation pédiatrique adaptée', ref: 'ETT-PED-4.5', tags: ['voies aériennes'], sel: false },
                { name: 'Pince à corps étranger rigide', ref: 'PCE-RIG-M', tags: ['extraction'], sel: false }
              ],
              checklist: [
                { done: true, text: '<strong>Polysomnographie</strong> — Quantification du syndrome obstructif' },
                { done: true, text: '<strong>Examen ORL + nasofibroscopie</strong> — Évaluation de l\'obstruction' },
                { done: false, text: '<strong>Bilan pré-anesthésique pédiatrique</strong> — Adapté au poids/âge' },
                { done: false, text: '<strong>Consentement parental éclairé</strong> — Information des parents' },
                { done: false, text: '<strong>Jeûne pédiatrique vérifié</strong> — Solide/liquide selon protocole' }
              ],
              patient: { id: '58390-PED', nom: 'Amrani, Yanis', age: 6, sexe: 'M', poids: 21, taille: 115, diag: 'Hypertrophie amygdalienne grade 3/4 avec syndrome d\'apnées obstructives du sommeil', urg: 'orange' },
              aiChips: ['Indication d\'amygdalectomie ?', 'Risque hémorragique post-amygdalectomie ?', 'Interprétation du score OSA-18 ?', 'Prise en charge du corps étranger ?'],
              hubProcs: ['Amygdalectomie', 'Adénoïdectomie', 'ATT', 'Extraction corps étranger']
            },
          ...
          //  masqué (voir .admin-only) tant que les Paramètres avancés ne sont pas activés.
          // ════════════════════════════════════════════════
          ...
          // Per-specialty base silhouette so laryngologie/otologie/rhinologie/etc. don't all look identical.
          const SPECIALTY_SHAPE = {
            laryngologie: { axis: { x: 0.6, y: 1.4, z: 0.6 }, lobes: 3, tubular: 0.6 },
            otologie: { axis: { x: 0.6, y: 0.6, z: 0.6 }, lobes: 4, tubular: 0.5 },
            rhinologie: { axis: { x: 1.2, y: 0.8, z: 0.9 }, lobes: 5, tubular: 0.4 },
            cervicofacial: { axis: { x: 1.3, y: 0.6, z: 0.55 }, lobes: 2, tubular: 0.3 },
            pediatrique: { axis: { x: 1.0, y: 0.7, z: 0.7 }, lobes: 2, tubular: 0.35 },
          ...
          function buildOrgan() {
            ...
            const shape = SPECIALTY_SHAPE[state.mod] || SPECIALTY_SHAPE.laryngologie;
      ...
      <div style="border:1px solid var(--border);border-radius:6px;padding:8px;margin-bottom:6px">
        ...
        ${s.local_path
          ...
          function _dicomBuildVoxelMesh(vol, N, threshold) {
            ...
            const color = new THREE.Color((MODULES[state.mod] || MODULES.laryngologie).color).getHex();
